...
void importData(ifstream& in_file_,
...
void headerOutputDataFile(ofstream& out_file_) {
...
void addStepsOutputDataFile(
		const vector<MeasurementPackage>& measurement_pack_list,
		ofstream& out_file_, const vector<GroundTruthPackage>& gt_pack_list) {
...
int main(int argc, char* argv[]) {
	...
	if (TESTING) {
		...
		addStepsOutputDataFile(measurement_pack_list, out_file_, gt_pack_list);
