 ...
 ******************************************************************************/
  ...
  Xsig.col(0) = x;
  MatrixXd x_replicated = x.replicate(1,5);
  MatrixXd Unsc_plus = x_replicated + sqrt(lambda+n_x)*A;
  MatrixXd Unsc_minus = x_replicated - sqrt(lambda+n_x)*A;
  Xsig.block<n_x,n_x>(0,1)  = Unsc_plus;
  Xsig.block<n_x,n_x>(0,6)  = Unsc_minus;
 ...
 ******************************************************************************/
  ...
  for (int i = 0; i < 2 * n_aug + 1; i++) {  //iterate over sigma points
    ...
    //angle normalization , TODO: Replace with m.unaryExpr<double(*)(double)>(&std::fmod)
